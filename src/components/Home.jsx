    ...
    <section className="bg-black text-white py-20 flex flex-col justify-center items-center  md:px-[8rem] ">
      <div className="flex flex-col md:flex-row items-center gap-[9rem] ">
        ...
        <div className="md:w-1/3 ">
          ...
          <div className="flex items-center space-x-4 text-white rounded-full bg-[#201E15] p-2">
            <button className="flex items-center px-6 py-3 rounded-full bg-yellow-700 font-medium hover:bg-yellow-500 transition">
              Portfolio
              <span className="ml-2 text-lg"><MdOutlineArrowOutward /></span>
            </button>
            <button className="px-6 py-3  font-medium  hover:text-yellow-700 transition">
              Hire me
            </button>
          </div>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end mt-8 md:mt-0">
          <div className="relative w-64 h-64 md:w-[30rem] md:h-[25rem] rounded-full overflow-hidden bg-yellow-400">
            <img
              src="/home.jpg" 
              alt="Home image"
